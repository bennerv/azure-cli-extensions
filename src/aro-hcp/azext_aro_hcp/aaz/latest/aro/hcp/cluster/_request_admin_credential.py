...
@register_command(
    "aro hcp cluster request-admin-credential",
    is_preview=True,
)
class RequestAdminCredential(AAZCommand):
    """Request a temporary credential for your Azure Red Hat OpenShift Hosted Control Plane Cluster
    """
...
class _RequestAdminCredentialHelper:
    """Helper class for RequestAdminCredential"""


__all__ = ["RequestAdminCredential"]
